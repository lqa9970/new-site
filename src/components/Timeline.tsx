...
import img2 from "../images/angular.png";
import img3 from "../images/angular.png";

const Timeline = () => {
  return (
    <div className="flex items-center h-auto text-red-600 w-100">
      {/* <Chrono mode="VERTICAL_ALTERNATING" theme={{ primary: "red" }}>
        <div>
          <p>Lorem Ipsum. Lorem Ipsum. Lorem IpsumIpsumIpsumIpsum</p>
        </div>
        <div>
          <img src={img1} />
        </div>
